  ...
  return (
    <div className='card services' id='services'>
      ...
      <p>
        ...
        listening. It also encompasses my principle motivation which is helping
        others. Before becoming the Director of the Green Room Coaching Practice
        I gathered over twenty years of professional coaching experience. I
        first qualified as a performance coach with the National Trust in the
        early 2000’s whilst leading their Stonehenge Project.
      </p>
      <p>
        Since that time I have worked with individuals, businesses, charities
        and communities largely in a listening and facilitating role which is
        the essence of what a coach does. Most of my important work has been
      ...
      <p>
        ...
        young person find their next best step. I continue to fulfil that
        mission but in a broader context. I want to help anyone seeking to make
        a leap into the unknown, but perhaps not knowing where to begin.
      </p>
      <p>
